...
interface inputForm extends Product {
  files?: File[];
}
...
export const AdminProductForm = ({ title, subTitle, product, isPending, onSubmit }: Props) => {
  ...
  useEffect(() => {
    if (isSubmitSuccessful) {
      setValue("files", []); // limpia "Imágenes por cargar"
    }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex justify-between items-center">
        <AdminTittle title={title} subtitle={subTitle} />
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                    {errors.price && <p className="text-red-500 text-sm">El Precio es requerido</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {errors.stock && <p className="text-red-500 text-sm">El Stock es requerido</p>}
                  </div>
                </div>
